	...
	#plot2
	png("plot2.png");
	plot(xval,feb$Global_active_power,type="l");
	plot(xval,feb$Global_active_power,type="l",xlab="",ylab="Global Active Power (kilowatts)");
	dev.off();
	...
	png("plot4.png");
	par(mfrow=c(2,2));
	plot(xval,feb$Global_active_power,type="l",xlab="",ylab="Global Active Power");
	plot(xval,feb$Voltage,type="l",xlab="datetime",ylab="Voltage");
	...
	plot(xval,feb$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type="l");
	dev.off();
